...
- 🤖 Passionate about AI systems, LLMs, and intelligent applications  
...
- **AI/ML:** LangGraph, FAISS, Embeddings, LLM APIs (Groq)  
- **Concepts:** DSA, System Design Basics, RAG Systems, OOP  
...
- ⚡ Batch grading for faster LLM evaluation
- 📎 Source-grounded answers with citations
- 📊 Live evaluation dashboard
- 💾 Persistent vector + keyword index system

👉 Demonstrates real-world AI system design + LLM pipeline engineering
...
- Become a strong AI Engineer (LLM + Systems)
- Master System Design + Scalable Architecture
- Improve advanced DSA problem solving
